    ...
    <div class="flex gap-2">
      <div class="flex-1 relative">
        ...
        <button
          ...
          {disabled}
          class="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-stone-500 dark:text-stone-400
      ...
      >
        ...
        <div class="flex items-center justify-between mb-4">
          <button
            ...
            class="p-2 sm:p-2.5 rounded-lg hover:bg-stone-100 dark:hover:bg-stone-700 transition-colors touch-manipulation"
          ...
          <div class="text-sm sm:text-base font-semibold text-stone-900 dark:text-stone-100">
            {monthYearDisplay}
          </div>
        ...
        <div class="grid grid-cols-7 gap-1 mb-2" role="row">
          {#each ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'] as day, index}
            <div 
              class="text-center text-xs sm:text-sm font-medium text-stone-500 dark:text-stone-400 py-2"
              role="columnheader"
